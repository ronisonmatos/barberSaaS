-- Corrige ambiguidade de nome: "token_acesso" e "agendamento_id" sao nomes de colunas
-- de saida (returns table) da funcao, entao o RETURNING precisa qualificar com o
-- nome da tabela para nao colidir com essas variaveis implicitas do plpgsql.
