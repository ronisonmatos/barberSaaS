-- Corrige erro 42804 detectado ao rodar supabase/tests/clube_assinatura.sql: a expressao
-- "case when ... then 'confirmado' else 'pendente' end" nao tem como o Postgres inferir que e
-- do tipo status_agendamento (os dois ramos sao literais de texto sem contexto), precisa de cast
-- explicito.
...
begin
  ...
  begin
    ...
    values (
      ...
      p_inicio, v_fim,
      (case when v_assinatura_id is not null then 'confirmado' else 'pendente' end)::status_agendamento,
