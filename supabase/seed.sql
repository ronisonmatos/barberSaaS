-- Seed de desenvolvimento: 1 barbearia demo com servicos, profissional e jornada.
...
insert into barbearias (id, nome, slug, telefone_whatsapp, descricao, timezone, status, trial_ate, plano_plataforma_id, config)
values (
  '00000000-0000-0000-0000-0000000000b1',
  'Barbearia Demo',
  'barbearia-demo',
  '+5547999999999',
  'Barbearia de demonstracao para desenvolvimento local.',
  'America/Sao_Paulo',
  'trial',
...
insert into profissionais (id, barbearia_id, nome, comissao_percentual, ativo)
values (
...
insert into servicos (id, barbearia_id, nome, descricao, duracao_minutos, preco_centavos, categoria, ativo)
values
