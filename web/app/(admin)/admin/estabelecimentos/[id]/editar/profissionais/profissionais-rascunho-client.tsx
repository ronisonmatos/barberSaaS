...
import { ProfissionalFormRascunho } from "./profissional-form-rascunho";
import { alternarAtivoProfissionalRascunho } from "./actions";
...
export function ProfissionaisRascunhoClient({
  estabelecimentoId,
  profissionais,
  servicos,
                ...
                <tr key={p.id} className="border-b border-linha text-carvao hover:bg-marfim">
                  ...
                  <td className="flex gap-2 py-2 text-right">
                    ...
                    <Button
                      ...
                      disabled={isPending}
                      onClick={() =>
                        startTransition(() => alternarAtivoProfissionalRascunho(estabelecimentoId, p.id, !p.ativo))
                      }
                    >
