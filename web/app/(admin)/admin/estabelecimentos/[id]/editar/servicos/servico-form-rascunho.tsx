...
import { salvarServicoRascunho } from "./actions";
...
export function ServicoFormRascunho({
  estabelecimentoId,
  servico,
  onDone,
}: {
  ...
  const [state, action, pending] = useActionState(salvarServicoRascunho, undefined);
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <Input name="duracao_minutos" type="number" min={1} required defaultValue={servico?.duracao_minutos} />
        </div>
        <div className="flex flex-col gap-1">
