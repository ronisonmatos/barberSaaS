...
import { PlanoClubeForm } from "./plano-form";
import { alternarAtivoPlanoClube } from "./actions";
...
export function PlanosClubeClient({ planos, servicos }: { planos: PlanoClube[]; servicos: Servico[] }) {
  ...
  function alternar(p: PlanoClube) {
    ...
    startTransition(async () => {
      const r = await alternarAtivoPlanoClube(p.id, !p.ativo);
