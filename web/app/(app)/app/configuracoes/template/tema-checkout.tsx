...
import { criarCobrancaPixTema, criarCobrancaCartaoTema, criarCheckoutTemaAsaas, statusPagamentoTema } from "./actions";
          ...
          <Button
            ...
            onClick={() => {
              ...
              startTransition(async () => {
                const r = await criarCheckoutTemaAsaas({ temaId });
